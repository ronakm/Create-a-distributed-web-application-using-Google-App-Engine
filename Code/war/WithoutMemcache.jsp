...
<body>
	...
	<h3 align="center">Operations on Google App Engine without Mem Cache</h3>
	...
	<div class="Withmemcache">
		...
		<div class="upload">
			...
			<form id="formUpload" enctype="multipart/form-data" method="post"
				action="<%=blobobj.createUploadUrl("/uploadfileswom")%>">
 ...
 */ %>
		...
		<div class="upload">
			...
			<form action="/searchfilewom" method="post" id="searchform">
				<p>Enter the filename to be searched :</p>
				<input type="text" name="filename"> <input name="searchtime"
					type="text" id="searchfield" hidden="hidden" /> <input
					id="dsubmit" type="button" value="Search File"
					onclick="SearchFile()">
			</form>
 ...
 */ %>		
		...
		<div class="upload">
			...
			<form action="/deletewom" method="post" id="deleteform">
