...
public class Searchfile extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		res.getWriter().println("......Search Operation in Distributed Storage System with mem cache.......\n");
		...
		if (flag == 1) {
			...
			res.getWriter().println("File found in Distributed Storage System. \n ");
			...
			res.getWriter().println("\nTime Taken " + durationString + "MilliSeconds \n ");


		} else {
			res.getWriter()
					.println("File not Found  in Distributed Storage System. \n ");
		}
